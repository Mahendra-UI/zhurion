...
export class HomesevenComponent implements OnInit, AfterViewInit {
...
onScroll(): void {
  ...
  const sections = ['home', 'about', 'keydifferentiators', 'services', 'contact'];
...
services = [
  {
    ...
    color: '#0d6efd',
    bg: '#e9f0ff',
    className: 'enterprise-app'  // 👈 custom class
  },
  {
    title: 'Digital Services',
    icon: 'bi-display',
